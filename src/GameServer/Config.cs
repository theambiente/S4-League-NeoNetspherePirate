...
namespace NeoNetsphere
{
  public class Config
  {
   ...
   [JsonProperty("res_check")] public bool ResCheck { get; set; }
    ...
    [JsonProperty("res_check_hash_red")] public string ResHash_red { get; set; }
    [JsonProperty("res_check_hash_gold")] public string ResHash_gold { get; set; }
    [JsonProperty("res_check_hash_blue")] public string ResHash_blue { get; set; }
    [JsonProperty("res_check_hash_violet")] public string ResHash_violet { get; set; }
  ...
  public class GameSettings
  {
    ...
    [JsonProperty("Weapon_Enchant_MP_Fill")] public uint WeaponEnchantMPFill { get; set; }

    [JsonProperty("Costume_Enchant_MP_Fill")] public uint CostumeEnchantMPFill { get; set; }
