...
namespace NeoNetsphere.Resource.xml
{
  ...
  public class ItemEffectDto
  {
    ...
    [XmlElement("item")] public ItemEffectItemDto[] item { get; set; }
  }
  ...
  public class ItemEffectItemDto
  {
    ...
    [XmlAttribute] public byte pumbi_star { get; set; }

    [XmlAttribute] public string desc_key { get; set; }

    [XmlElement("attribute")] public ItemEffectItemAttributeDto[] attribute { get; set; }
  }
  ...
  {
    [XmlAttribute] public string effect { get; set; }

    [XmlAttribute] public int graph_value { get; set; }

    [XmlAttribute] public int value { get; set; }

    [XmlAttribute] public string rate { get; set; }
  }
}