...
namespace NeoNetsphere
{
  public class IpInfo //http://freegeoip.net/json/
  {
    ...
    [JsonProperty("country_name")] public string country_name { get; set; }

    [JsonProperty("region_code")] public string region_code { get; set; }

    [JsonProperty("region_name")] public string region_name { get; set; }
    ...
    [JsonProperty("metro_code")] public string metro_code { get; set; }
