...
namespace NeoNetsphere.Network.Message.Chat
{
  ...
  public class FriendActionAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public FriendResult Result { get; set; }

    [BlubMember(1)] public int Unk { get; set; }

    [BlubMember(2)] public FriendDto Friend { get; set; }
  }
  ...
  public class CombiActionAckMessage : IChatMessage
  {
    ...
    [BlubMember(2)] public CombiDto Combi { get; set; }
  }
  ...
  public class DenyActionAckMessage : IChatMessage
  {
    ...
    [BlubMember(1)] public DenyAction Action { get; set; }

    [BlubMember(2)] public DenyDto Deny { get; set; }
  }
  ...
  public class ChannelEnterPlayerAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public PlayerInfoShortDto UserData { get; set; }
  }
  ...
  public class MessageChatAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public ChatType ChatType { get; set; }
  ...
  public class MessageWhisperChatAckMessage : IChatMessage
  {
    ...
    public class RoomInvitationPlayerAckMessage : IChatMessage
    {
        ...
        [BlubMember(0)] public ulong SenderId { get; set; }

        [BlubMember(1, typeof(StringSerializer))]
        public string SenderNickname { get; set; }

        [BlubMember(2)] public PlayerLocationDto Location { get; set; }
    }
  ...
  public class NoteListAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public int PageCount { get; set; }

    [BlubMember(1)] public byte CurrentPage { get; set; }

    [BlubMember(2)] public int Unk3 { get; set; } // MessageType? - MessageType UI does not exist in this version
  ...
  public class NoteReadAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public ulong Id { get; set; }

    [BlubMember(1)] public NoteContentDto Note { get; set; }
  ...
  public class NoteCountAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public byte NoteCount { get; set; }
  ...
  public class ChatPlayerInfoAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public PlayerInfoDto Player { get; set; }
  }
  ...
  public class PlayerPositionAckMessage : IChatMessage
  {
    ...
    [BlubMember(1)] public PlayerInfoDto Player { get; set; }
  }

  [BlubContract]
  public class ChatPlayerInfoListAckMessage : IChatMessage
  {
  ...
  public class UserDataFourAckMessage : IChatMessage
  {
    ...
    [BlubMember(1)] public UserDataDto UserData { get; set; }
  }

  [BlubContract]
  public class ClanChangeNoticeAckMessage : IChatMessage
  {
    [BlubMember(0)] public string Unk { get; set; }
  }
  ...
  public class ClubSystemMessageMessage : IChatMessage
  {
    ...
    [BlubMember(1)] public string Message { get; set; }
  }
  ...
  public class ClubMemberLoginStateAckMessage : IChatMessage
  {
    ...
    [BlubMember(0)] public int State { get; set; }
  ...
  public class Chennel_PlayerNameTagList_AckMessage : IChatMessage
  {
    ...
    {
      NameTags = Array.Empty<PlayerNameTagInfoDto>();
    }

    public Chennel_PlayerNameTagList_AckMessage(PlayerNameTagInfoDto[] nameTags)
    {
            NameTags = nameTags;
    ...
    [BlubMember(0, typeof(ArrayWithIntPrefixSerializer))]
    public PlayerNameTagInfoDto[] NameTags { get; set; }
  }
  ...
  public class ClubClubMemberInfoAck2Message : IChatMessage
  {
    ...
    [BlubMember(3)] public int Unk1 { get; set; }

    [BlubMember(4)] public int Unk2 { get; set; }

    [BlubMember(5)] public int IsModerator { get; set; }

    [BlubMember(6)] public int Unk4 { get; set; }
    ...
    [BlubMember(9)] public int Unk6 { get; set; } //MemberCount? MemberIndex?

    [BlubMember(10, typeof(StringSerializer))]
    public string Unk7 { get; set; }

    [BlubMember(11)] public long Unk8 { get; set; }

    [BlubMember(12)] public int Unk9 { get; set; }

    [BlubMember(13)] public int Unk10 { get; set; }
  }
}
