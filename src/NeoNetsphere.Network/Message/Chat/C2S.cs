namespace NeoNetsphere.Network.Message.Chat
{
  ...
  {
    [BlubMember(0)] public DenyAction Action { get; set; }

    [BlubMember(1)] public DenyDto Deny { get; set; }
  }

  [BlubContract]
  public class FriendActionReqMessage : IChatMessage
  {
    [BlubMember(0)] public FriendAction Action { get; set; }
  ...
  public class UserDataThreeAckMessage : IChatMessage
  {
    ...
    [BlubMember(2)] public UserDataDto UserData { get; set; }
  }
  ...
  {
    [BlubMember(0)] public byte Page { get; set; }

    [BlubMember(1)] public int MessageType { get; set; }
  }
  ...
  public class NoteSendReqMessage : IChatMessage
  {
    ...
    [BlubMember(1)] public ulong Unk1 { get; set; }
    ...
    [BlubMember(5)] public NoteGiftDto Gift { get; set; }
  }
  ...
  {
    [BlubMember(0)] public int AllowCombi { get; set; }

    [BlubMember(1)] public int AllowInvite { get; set; }

    [BlubMember(2)] public int RevealInfo { get; set; }

    [BlubMember(3)] public int AllowFriendReq { get; set; }
  }

  [BlubContract]
  public class OptionSaveBinaryReqMessage : IChatMessage
  {
    [BlubMember(0)] public uint Checksum { get; set; }
  ...
  {
    [BlubMember(0)] public ClubNoteDto Note { get; set; }
  }

  [BlubContract]
  public class ClubMemberListReqMessage : IChatMessage
  {
    [BlubMember(0)] public int ClanId { get; set; }
  }
