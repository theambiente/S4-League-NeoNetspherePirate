...
namespace NeoNetsphere.Network.Message.P2P
{
  ...
  public class PlayerSpawnReqMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public CharacterDto Character { get; set; }
  }
  ...
  public class SnapShotMessage : IP2PMessage
  {
    ...
    [BlubMember(1)] public byte Unk { get; set; } // 3 bits, 5 bits
  ...
  public class StateSyncMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public uint GameTime { get; set; }

    [BlubMember(1)] public int Value { get; set; }

    [BlubMember(2)] public ActorState State { get; set; }

    [BlubMember(3)] public byte CurrentWeapon { get; set; } // 4 bits, 4 bits
  }
  ...
  public class BGEffectMessage : IP2PMessage
  {
    ...
    [BlubMember(5)] public byte Unk5 { get; set; }

    [BlubMember(6)] public short Unk6 { get; set; }

    [BlubMember(7)] public byte Unk7 { get; set; }

    [BlubMember(8)] public byte Unk8 { get; set; } // 4 bits, 4 bits
  }
  ...
  public class DefensivePowerMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public PeerId PeerId { get; set; }
  ...
  public class BlastObjectDestroyMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public PeerId Player { get; set; }
  ...
  public class MindEnergyMessage : IP2PMessage
  {
    ...
    [BlubMember(1)] public PeerId Target { get; set; }

    [BlubMember(2)] public short Unk3 { get; set; }
    ...
    [BlubMember(5)] public byte Unk6 { get; set; }
  }
  ...
  {
    [BlubMember(0)] public byte Action { get; set; }

    [BlubMember(1)] public bool IsEnabled { get; set; }

    [BlubMember(2)] public byte Value { get; set; }
  }
  ...
  public class SentryGunSpawnMessage : IP2PMessage
  {
    ...
    [BlubMember(2)] public float Unk3 { get; set; }

    [BlubMember(3)] public float Unk4 { get; set; }
  ...
  {
    [BlubMember(0)] public PeerId Id { get; set; }

    [BlubMember(1)] public byte Unk1 { get; set; }

    [BlubMember(2)] public PeerId Unk2 { get; set; }
  }
  ...
  public class GrenadeSpawnMessage : IP2PMessage
  {
    ...
    [BlubMember(1)] public PeerId Owner { get; set; }
  ...
  public class ObstructionSpawnMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public PeerId Owner { get; set; }

    [BlubMember(1)] public PeerId Id { get; set; }
    ...
    [BlubMember(4)] public int Unk2 { get; set; }

    [BlubMember(5)] public int Unk3 { get; set; }

    [BlubMember(6)] public byte Unk4 { get; set; }
  }
  ...
  public class ObstructionDamageMessage : IP2PMessage
  {
    ...
    [BlubMember(1)] public uint Damage { get; set; }
  }
  ...
  public class SyncObjectObstructionMessage : IP2PMessage
  {
    ...
    [BlubMember(2)] public uint GameTime { get; set; }
    ...
    [BlubMember(5)] public uint Count { get; set; }

    [BlubMember(6)] public uint HP { get; set; }

    [BlubMember(7)] public uint Time { get; set; }
  }
  ...
  public class AttachArcadeItemMessage : IP2PMessage
  {
    ...
    [BlubMember(1)] public int Unk { get; set; }
  }
  ...
  {
    [BlubMember(0)] public PeerId Unk1 { get; set; }

    [BlubMember(1)] public PeerId Unk2 { get; set; }
  ...
  public class ConditionInfoMessage : IP2PMessage
  {
    ...
    [BlubMember(0)] public PeerId Unused { get; set; }

    [BlubMember(1)] public PeerId Target { get; set; }

    [BlubMember(2)] public Condition Condition { get; set; }
