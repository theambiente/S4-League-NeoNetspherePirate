...
namespace NeoNetsphere.Network.Message.GameRule
{
    ...
    public class RoomEnterPlayerAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public byte Unk1 { get; set; } // 0 = char does not spawn

        [BlubMember(2)] public PlayerGameMode PlayerGameMode { get; set; }

        [BlubMember(3)] public int ClanId { get; set; }

        [BlubMember(4, typeof(StringSerializer))]
        public string Nickname { get; set; }

        [BlubMember(5)] public Team Team { get; set; }
    }
    ...
    public class RoomLeavePlayerAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(2)] public RoomLeaveReason Reason { get; set; }
    }

    [BlubContract]
    public class RoomLeaveReqeustAckMessage : IGameRuleMessage
    {
        [BlubMember(0)] public byte Unk { get; set; } // result?
    }
    ...
    public class RoomChangeTeamAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public Team Team { get; set; }

        [BlubMember(2)] public PlayerGameMode Mode { get; set; }
    }
    ...
    public class RoomChangeTeamFailAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ChangeTeamResult Result { get; set; }
    }
    ...
    public class RoomChoiceTeamChangeAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ulong PlayerToMove { get; set; }

        [BlubMember(1)] public ulong PlayerToReplace { get; set; }

        [BlubMember(2)] public Team FromTeam { get; set; }

        [BlubMember(3)] public Team ToTeam { get; set; }
    }
    ...
    public class GameEventMessageAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public GameEventMessage Event { get; set; }

        [BlubMember(1)] public ulong AccountId { get; set; }

        [BlubMember(2)] public uint Unk { get; set; } // server/game time or something like that

        [BlubMember(3)] public ushort Value { get; set; }
    ...
    public class GameBriefingInfoAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public bool IsResult { get; set; }

        [BlubMember(1)] public bool IsEvent { get; set; }
    ...
    public class GameChangeStateAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public GameState State { get; set; }
    }
    ...
    public class GameChangeSubStateAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public GameTimeState State { get; set; }
    }
    ...
    public class RoomReadyRoundAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public bool IsReady { get; set; }

        [BlubMember(2)] public byte Result { get; set; }
    }
    ...
    public class GameAvatarChangeAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ChangeAvatarUnk1Dto Unk1 { get; set; }
    ...
    public class RoomChangeRuleNotifyAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ChangeRuleDto Settings { get; set; }
    }
    ...
    public class RoomChangeRuleNotifyAck2Message : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ChangeRuleDto2 Settings { get; set; }
    }
    ...
    public class ScoreMissionScoreAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public int Score { get; set; }
    }
    ...
    public class ScoreKillAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ScoreDto Score { get; set; }
    }
    ...
    public class ScoreKillAssistAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ScoreAssistDto Score { get; set; }
    }
    ...
    public class ScoreHealAssistAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public LongPeerId Id { get; set; }
    }
    ...
    public class ScoreGoalAssistAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public LongPeerId Assist { get; set; }
    }
    ...
    public class ScoreReboundAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public LongPeerId NewId { get; set; }

        [BlubMember(1)] public LongPeerId OldId { get; set; }
    }
    ...
    public class ScoreTeamKillAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public Score2Dto Score { get; set; }
    }
    ...
    public class RoomChangeItemAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(0)] public ChangeItemsUnkDto Unk1 { get; set; }
    ...
    public class RoomPlayModeChangeAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public PlayerGameMode Mode { get; set; }
    }
    ...
    public class GameRefreshGameRuleInfoAckMessage : IGameRuleMessage
    {
        ...
        public GameRefreshGameRuleInfoAckMessage(GameState _GameState, GameTimeState _GameTimeState, double _ElapsedTime)
        {
            GameState = _GameState;
            GameTimeState = _GameTimeState;
            ElapsedTime = (int)_ElapsedTime;
        }

        [BlubMember(0)] public GameState GameState { get; set; }

        [BlubMember(1)] public GameTimeState GameTimeState { get; set; }

        [BlubMember(2)] public int ElapsedTime { get; set; }
    }
    ...
    {
        [BlubMember(0)] public float Value { get; set; }
    }
    ...
    {
        [BlubMember(0)] public byte Stage { get; set; }
    }
    ...
    public class SlaughterAttackPointAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public float Unk1 { get; set; }

        [BlubMember(2)] public float Unk2 { get; set; }
    }
    ...
    public class SlaughterHealPointAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(1)] public float Unk { get; set; }
    }
    ...
    public class MoneyUseCoinAckMessage : IGameRuleMessage
    {
        ...
        [BlubMember(3)] public int Value { get; set; }
        ...
        {
            [BlubMember(0)] public VoteKickMessage Message { get; set; }
        }

        [BlubContract]
        public class GameKickOutVoteResultAckMessage : IGameRuleMessage
        {
            [BlubMember(0)] public VoteKickResult Result { get; set; }
        }

        [BlubContract]
        public class GameKickOutStateAckMessage : IGameRuleMessage
        {
            [BlubMember(0)] public VoteKickDialogStyle DialogStyle { get; set; }

            [BlubMember(1)] public uint YesCount { get; set; }

            [BlubMember(2)] public uint PlayerVoted { get; set; }

            [BlubMember(3)] public VoteKickReason Reason { get; set; }

            [BlubMember(4)] public ulong Sender { get; set; }

            [BlubMember(5)] public ulong Target { get; set; }
        }
        ...
        public class CaptainSubRoundWinAckMessage : IGameRuleMessage
        {
            ...
            public CaptainSubRoundWinAckMessage(int result, bool unk2)
            {
                Result = result;
                Unk2 = unk2;
            }
            ...
            [BlubMember(1)] public bool Unk2 { get; set; } //?
        }
        ...
        public class CaptainCurrentRoundInfoAckMessage : IGameRuleMessage
        {
            ...
            public CaptainCurrentRoundInfoAckMessage(uint AlphaWins, uint BetaWins)
            {
                Unk1 = AlphaWins;
                Unk2 = BetaWins;
            }
        ...
        {
            [BlubMember(0)] public SeizeIntrudeInfoDto[] Infos { get; set; }
        }
        ...
        {
            [BlubMember(0)] public ulong Unk1 { get; set; }
        ...
        {
            [BlubMember(0)] public byte Unk1 { get; set; } //result?
        ...
        public class GameTackUpdateAckMessage : IGameRuleMessage
        {
            ...
            [BlubMember(1)] public short Unk2 { get; set; }
        }
        ...
        public class RoomGameEndLoadingAckMessage : IGameRuleMessage
        {
            ...
            [BlubMember(0)] public ulong Unk { get; set; }
        }
        ...
        public class RoomGamePlayCountDownAckMessage : IGameRuleMessage
        {
            ...
            [BlubMember(0)] public int TimeinMs { get; set; }
        }

        [BlubContract]
        public class InGameItemDropAckMessage : IGameRuleMessage
        {
            [BlubMember(0)] public ItemDropAckDto Item { get; set; }
        }

        [BlubContract]
        public class InGameItemGetAckMessage : IGameRuleMessage
        {
            [BlubMember(0)] public long Unk1 { get; set; }
        ...
        public class ChallengeRankersAckMessage : IGameRuleMessage
        {
            ...
            [BlubMember(1)] public ChallengeRankerDto[] Rankers { get; set; }
        }
        ...
        public class RoomEnterPlayerForBookNameTagsAckMessage : IGameRuleMessage
        {
            ...
            [BlubMember(3)] public uint Exp { get; set; }

            [BlubMember(4, typeof(StringSerializer))]
            public string Nickname { get; set; }

            [BlubMember(5)] public uint Unk1 { get; set; }
        ...
        public RoomEnterPlayerForBookNameTagsAckMessage(ulong accountId, string nickname, uint totalExperience,
            PlayerGameMode mode, Team team, byte unk1, uint nameTag)
        {
            AccountId = accountId;
            Nickname = nickname;
            Exp = totalExperience;
