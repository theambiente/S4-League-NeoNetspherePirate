...
namespace NeoNetsphere.Network.Message.GameRule
{
  ...
  public class RoomLeaveReguestReqMessage : IGameRuleMessage
  {
    ...
    [BlubMember(1)] public RoomLeaveReason Reason { get; set; }
  }

  [BlubContract]
  public class RoomTeamChangeReqMessage : IGameRuleMessage
  {
    [BlubMember(0)] public Team Team { get; set; }
  ...
  public class GameEventMessageReqMessage : IGameRuleMessage
  {
    ...
    [BlubMember(2)] public uint Unk1 { get; set; } // server/game time or something like that

    [BlubMember(3)] public ushort Value { get; set; }

    [BlubMember(4)] public uint Unk2 { get; set; }
  }
  ...
  {
    [BlubMember(0)] public bool IsReady { get; set; }
  }
  ...
  {
    [BlubMember(0)] public int Score { get; set; }
  }
  ...
  {
    [BlubMember(0)] public ScoreAssist2Dto Score { get; set; }
  }
  ...
  {
    [BlubMember(0)] public LongPeerId PeerId { get; set; }
  }
  ...
  public class ScoreSuicideReqMessage : IGameRuleMessage
  {
    ...
    [BlubMember(1)] public uint Icon { get; set; }
  }
  ...
  {
    [BlubMember(0)] public PlayerGameMode Mode { get; set; }
  }
  ...
  {
    [BlubMember(0)] public float Unk { get; set; }
  }
  ...
  {
    [BlubMember(0)] public BuffType BuffType { get; set; }
  }
  ...
  public class LogWeaponFireReqMessage : IGameRuleMessage
  {
    ...
    [BlubMember(1)] public float Unk2 { get; set; }

    [BlubMember(2)] public int Unk3 { get; set; }

    [BlubMember(3)] public ulong Unk4 { get; set; }

    [BlubMember(4)] public int Unk5 { get; set; }

    [BlubMember(5)] public string Unk6 { get; set; }

    [BlubMember(6)] public int Unk7 { get; set; }

    [BlubMember(7)] public byte Unk8 { get; set; }
  }

  [BlubContract]
  public class GameKickOutRequestReqMessage : IGameRuleMessage
  {
    [BlubMember(0)] public ulong Sender { get; set; }

    [BlubMember(1)] public ulong Target { get; set; }

    [BlubMember(2)] public VoteKickReason Reason { get; set; }
  }

  [BlubContract]
  public class GameKickOutVoteResultReqMessage : IGameRuleMessage
  {
    [BlubMember(0)] public bool IsYes { get; set; }
  }
  ...
  {
    [BlubMember(0)] public uint CaptureId { get; set; }

    [BlubMember(1)] public bool IsCapturing { get; set; }

    [BlubMember(2)] public uint Unk { get; set; }
  }

  [BlubContract]
  public class SeizeBuffItemGainReqMessage : IGameRuleMessage
  {
    [BlubMember(0)] public ulong Item { get; set; }
  }
  ...
  {
    [BlubMember(0)] public EquipCheckDto Equip { get; set; }
  }
  ...
  {
    [BlubMember(0)] public ItemDropDto Item { get; set; }
  }
  ...
  {
    [BlubMember(0)] public ChallengeResultDto Item { get; set; }
  }
