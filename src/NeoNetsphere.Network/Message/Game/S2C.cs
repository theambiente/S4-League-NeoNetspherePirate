...
namespace NeoNetsphere.Network.Message.Game
{
    ...
    public class RandomShopUpdateInfoAckMessage : IGameMessage
    {
        ...
        [BlubMember(0)]
        public byte RandomShopType { get; set; }
    ...
    {
        [BlubMember(0)]
        public int Unk1 { get; set; } //Usually Equals 1
    ...
    [BlubContract]
    public class EnchantItemAckMessage : IGameMessage
    {
        [BlubMember(0)]
    ...
    [BlubContract]
    public class ItemMPRefillAckMessage : IGameMessage
    {
        [BlubMember(0)]
        public int Result { get; set; }
    }
