...
namespace NeoNetsphere.Network.Message.Game
{
    ...
    public class LoginRequestReqMessage : IGameMessage
    {
        ...
        [BlubMember(3)] public short Unk2 { get; set; } //514

        [BlubMember(4)] public byte Unk3 { get; set; } //1

        [BlubMember(5)] public byte Unk4 { get; set; } //94

        [BlubMember(6)] public ulong AccountId { get; set; }
        ...
        [BlubMember(9)] public bool KickConnection { get; set; }

        [BlubMember(10, typeof(StringSerializer))]
        public string Unk6 { get; set; }

        [BlubMember(11)] public uint Unk7 { get; set; }
    ...
    {
        [BlubMember(0)] public NeoNetsphere.GameRule GameRule { get; set; }

        [BlubMember(1)] public byte MapId { get; set; }

        [BlubMember(2)] public byte PlayerLimit { get; set; }

        [BlubMember(3)] public short ScoreLimit { get; set; }

        [BlubMember(4)] public byte TimeLimit { get; set; }

        [BlubMember(5)] public int WeaponLimit { get; set; }
        ...
        [BlubMember(8)] public bool HasSpectator { get; set; }

        [BlubMember(9)] public byte SpectatorLimit { get; set; }

        [BlubMember(10)] public long Unk1 { get; set; }

        [BlubMember(11)] public byte Unk2 { get; set; }

        [BlubMember(12)] public byte CreationId { get; set; } //weird id

        [BlubMember(13)] public int Unk4 { get; set; }

        [BlubMember(14)] public int FMBURNMode { get; set; }

#if LATESTS4
        [BlubMember(15)] public int ServerKey { get; set; }
#endif
    }
    ...
    public class RoomMakeReqMessage : IGameMessage
    {
        ...
        [BlubMember(12)] public byte Unk3 { get; set; } //weird id
    }
    ...
    {
        [BlubMember(0)] public UseItemAction Action { get; set; }

        [BlubMember(1)] public byte CharacterSlot { get; set; }

        [BlubMember(2)] public byte EquipSlot { get; set; }

        [BlubMember(3)] public ulong ItemId { get; set; }
    }

    [BlubContract]
    public class RoomLeaveReqMessage : IGameMessage
    {
        [BlubMember(0)] public RoomLeaveReason Reason { get; set; }
    }

    [BlubContract]
    public class TimeSyncReqMessage : IGameMessage
    {
        [BlubMember(0)] public uint Time { get; set; }
    }
    ...
    {
        [BlubMember(0)] public uint Channel { get; set; }
    }
    ...
    {
        [BlubMember(0)] public ChannelInfoRequest Request { get; set; }
    }
    ...
    public class RoomEnterReqMessage : IGameMessage
    {
        ...
        [BlubMember(3)] public byte Unk2 { get; set; }
    }
    ...
    {
        [BlubMember(0)] public ItemLicense License { get; set; }
    }
    ...
    public class TaskReguestReqMessage : IGameMessage
    {
        ...
        [BlubMember(1)] public uint TaskId { get; set; }

        [BlubMember(2)] public byte Unk2 { get; set; } // slot?
    }
    ...
    public class NewShopUpdateCheckReqMessage : IGameMessage
    {
        ...
        [BlubMember(4)] public uint Checksum01 { get; set; }

        [BlubMember(5)] public uint Checksum02 { get; set; }

        [BlubMember(6)] public uint Checksum03 { get; set; }

        [BlubMember(7)] public uint Checksum04 { get; set; }
    }
    ...
    {
        [BlubMember(0)] public uint RequestId { get; set; }

        [BlubMember(1)] public uint LanguageId { get; set; }

        [BlubMember(2)] public uint Command { get; set; }
    }
    ...
    {
        [BlubMember(0)] public long Unk { get; set; }
    ...
    public class NoteGiftItemReqMessage : IGameMessage
    {
        ...
        [BlubMember(5)] public ShopItemDto Unk6 { get; set; }

        [BlubMember(6)] public long Unk7 { get; set; }
    }
    ...
    {
        [BlubMember(0)] public int GameRule { get; set; }
    }
    ...
    [BlubContract]
    public class ItemEnchantReqMessage : IGameMessage
    {
        [BlubMember(0)]
    ...
    {
        [BlubMember(0)] public int Mode { get; set; }

        [BlubMember(1)] public int Index { get; set; }
    }
    ...
    [BlubContract]
    public class BattleyeC2SDataMessage : IGameMessage
    {
    ...
    [BlubContract]
    public class ItemMPRefillReqMessage : IGameMessage
    {
        [BlubMember(0)]
        public ulong ItemId
        {
