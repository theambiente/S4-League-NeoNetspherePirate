...
namespace NeoNetsphere.Network.Message.Game
{
  ...
  public class GameMessageFactory : MessageFactory<GameOpCode, IGameMessage>
  {
    ...
    public GameMessageFactory()
    {
      ...
      Register<GameClubJoinAckMessage>(GameOpCode.ClubJoinAck);
      ...
      Register<EnchantItemAckMessage>(GameOpCode.EnchantEnchantItemAck);
      ...
      Register<ItemMPRefillAckMessage>(GameOpCode.Use_Instant_Item_Ack);
      ...
      Register<ItemEnchantReqMessage>(GameOpCode.ItemEnchanReq);
      ...
      Register<ItemMPRefillReqMessage>(GameOpCode.Use_Instant_Item_Req);
#if NEWIDS
            //S2C
            ...
            Register<BattleyeS2CDataMessage>(GameOpCode.Battleye_S2C_Data);
            Register<PlayerKickMessageAckMessage>(GameOpCode.Player_Kick_Message_Ack);
            Register<EspherChipLv5Message>(GameOpCode.EspherChip_Lv5);
            //Collectbook//Nametags
            Register<CollectBookUpdateRequestAckMessage>(GameOpCode.CollectBook_UpdateRequest_Ack);
            Register<CollectBookUpdateCheckAckMessage>(GameOpCode.CollectBook_UpdateCheck_Ack);
            Register<CollectBookUpdateInfoAckMessage>(GameOpCode.CollectBook_UpdateInfo_Ack);
            Register<CollectBookInventoryInfoAckMessage>(GameOpCode.CollectBook_InventoryInfo_Ack); 
            Register<CollectBookInvenEffectInfoAckMessage>(GameOpCode.CollectBook_InvenEffectInfo_Ack);
            Register<CollectBookItemRegistAckMessage>(GameOpCode.CollectBook_ItemRegist_Ack);
            Register<CollectBookEffectRegistAckMessage>(GameOpCode.CollectBook_EffectRegist_Ack);
            Register<CollectBookExpireBookRewardAckMessage>(GameOpCode.CollectBook_ExpireBookReward_Ack);
            Register<CollectBookResuseBookRewardAckMessage>(GameOpCode.CollectBook_ResuseBookReward_Ack);
            Register<CollectBookBookUseRewardAckMessage>(GameOpCode.CollectBook_BookUseReward_Ack);
            Register<CollectBookBookUnRegistAckMessage>(GameOpCode.CollectBook_BookUnRegist_Ack);
            Register<RoomEnterPlayerInfoForCollectBookAckMessage>(GameOpCode.Room_EnterPlayerInfoForCollectBook_Ack);
            ...
            Register<BattleyeC2SDataMessage>(GameOpCode.Battleye_C2S_Data);
            //collectbook//Nametags
            Register<CollectBookUpdateCheckReqMessage>(GameOpCode.CollectBook_UpdateCheck_Req);
            Register<CollectBookInventoryInfoReqMessage>(GameOpCode.CollectBook_InventoryInfo_Req);
            //Register<CollectBookItemRegistReqMessage>(GameOpCode.CollectBookItemRegistReq);
            Register<CollectBookUseRewardReqMessage>(GameOpCode.CollectBook_UseReward_Req);
