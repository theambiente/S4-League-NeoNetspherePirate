...
namespace NeoNetsphere.Network.Data.GameRule
{
  ...
  public class SeizeUpdateInfoDto
  {
    ...
    [BlubMember(0)] public short Unk1 { get; set; }
    ...
    [BlubMember(4)] public short Unk5 { get; set; }

    [BlubMember(5)] public short Unk6 { get; set; }

    [BlubMember(6)] public int Unk7 { get; set; }

    [BlubMember(7)] public int Unk8 { get; set; }

    [BlubMember(8)] public int Unk9 { get; set; }

    [BlubMember(9)] public long Unk10 { get; set; }
