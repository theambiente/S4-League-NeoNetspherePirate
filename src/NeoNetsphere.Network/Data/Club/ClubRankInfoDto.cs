...
namespace NeoNetsphere.Network.Data.Club
{
  ...
  public class ClubRankInfoDto
  {
    ...
    [BlubMember(4)] public uint Unk3 { get; set; }

    [BlubMember(5)] public uint Unk4 { get; set; }

    [BlubMember(6)] public uint Unk5 { get; set; }

    [BlubMember(7, typeof(StringSerializer))]
    public string MasterName { get; set; }

    [BlubMember(8)] public uint Unk6 { get; set; }

    [BlubMember(9)] public uint Unk7 { get; set; }

    [BlubMember(10)] public uint Unk8 { get; set; }
