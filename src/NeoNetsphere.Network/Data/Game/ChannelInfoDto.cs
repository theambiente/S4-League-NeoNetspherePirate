...
namespace NeoNetsphere.Network.Data.Game
{
  ...
  public class ChannelInfoDto
  {
    ...
    [BlubMember(0)] public ushort Id { get; set; }

    [BlubMember(1)] public ushort PlayersOnline { get; set; }

    [BlubMember(2)] public ushort PlayerLimit { get; set; }
    ...
    [BlubMember(8)] public uint MinLevel { get; set; }

    [BlubMember(9)] public uint MaxLevel { get; set; }

    [BlubMember(10)] public float minKD { get; set; }

    [BlubMember(11)] public float maxKD { get; set; }
  }
}
