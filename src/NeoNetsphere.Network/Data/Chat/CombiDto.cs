...
namespace NeoNetsphere.Network.Data.Chat
{
  ...
  public class CombiDto
  {
    ...
    [BlubMember(4)] public ulong Unk5 { get; set; }

    [BlubMember(5)] public ulong Unk6 { get; set; }

    [BlubMember(6)] public ulong Unk7 { get; set; }

    [BlubMember(7)] public ulong Unk8 { get; set; }

    [BlubMember(8)] public ulong Unk9 { get; set; }
