...
namespace ProudNetSrc.Serialization.Messages
{
  ...
  {
    [BlubMember(0)] public int RecentFrameRate { get; set; }
  }
  ...
  {
    [BlubMember(0)] public uint GroupHostId { get; set; }

    [BlubMember(1)] public uint AddedMemberHostId { get; set; }

    [BlubMember(2)] public uint EventId { get; set; }

    [BlubMember(3)] public bool LocalPortReuseSuccess { get; set; }
  }
  ...
  {
    [BlubMember(0)] public short Unk { get; set; }
  }
  ...
  {
    [BlubMember(0)] public TraceId TraceId { get; set; }
  ...
  internal class ReportC2CUdpMessageCountMessage : IMessage
  {
    ...
    [BlubMember(1)] public uint UdpMessageTrialCount { get; set; }

    [BlubMember(2)] public uint UdpMessageSuccessCount { get; set; }
  }

  [BlubContract]
  internal class ReportC2SUdpMessageTrialCountMessage : IMessage
  {
    [BlubMember(0)] public int TrialCount { get; set; }
  }
}
