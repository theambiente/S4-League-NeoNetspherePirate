...
{
  public class ProudFrameException : Exception
  {
    public ProudFrameException()
    {
    }

    public ProudFrameException(string message)
        : base(message)
    {
    }

    public ProudFrameException(string message, Exception innerException)
